...
public class MoviesController : ControllerBase
{
    private static readonly List<Movie> _movies = new()
    {
        ...
        new Movie
        {
            ...
            VideoUrl = "https://www.youtube.com/embed/8ugaeA-nMTc?start=99&end=103&autoplay=1&mute=1&controls=0&loop=1&playlist=8ugaeA-nMTc&playsinline=1&rel=0&modestbranding=1&showinfo=0&iv_load_policy=3",
            Year = 2008,
